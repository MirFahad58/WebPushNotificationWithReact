      ...
      <div>
        <div className="App">
          ...
          <p className="App-intro">
            To get refresh token, click on <code>Generate Token</code> and send
            this to app Server.
          </p>
          <div>
          ...
          <div>
            <Message severity="warn" text={this.state.msgCount} />
          </div>;
        </div>
        <Accordion multiple>{this.state.accordionTabs}</Accordion>
      </div>
    );
  }
}
